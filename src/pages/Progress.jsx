...
export default function Progress() {
  ...
  return (
    <motion.div
      ...
      className="container mx-auto p-6  text-gray-100 dark:text-gray-800 "
    >
      ...
      <div className="grid md:grid-cols-3 gap-6 mb-8">
        ...
        >
          ...
          <div className="relative pt-1">
            ...
            <div className="overflow-hidden h-2 mb-4 text-xs flex rounded bg-purple-200 dark:bg-purple-700">
              <motion.div
                initial={{ width: 0 }}
      ...
      <div className=" rounded-xl shadow-lg p-6">
        ...
        <div className="space-y-4">
          {statistics.dailyCompletion.map((day) => (
            <div key={day.date} className="border-b border-gray-200 dark:border-gray-700 pb-4">
              ...
              <div className="overflow-hidden h-2 text-xs flex rounded bg-blue-200 dark:bg-blue-700">
                <motion.div
                  initial={{ width: 0 }}
